...
function Canteen_login()
 {
    ...
    function onLoginFormSubmit(userCredential)
    {
      ...
      .then((userarray)=>{
        ...
        else
        {
          ...
          if(result===true)
          {
          navigate(`/canteen_admin/${userCredential.username}`,{state:userarray[0]})
          }
          else{
  ...
  return (
    <div className='d-block mx-auto w-50 bg-secondary p-4 mt-5' >
        <h1 className='fs-1 text-warning text-center fw-bold'>Canteen Login</h1>
