 ...
 // }
  ...
  return (
    ...
    <Link  className="nav-link" to='/get_active_users'>  <div className="text-end"><button className="btn btn-success" >Get Active Users</button></div></Link>
      <h1 className="fs-3 text-center mt-2 fw-bold mb-5 ">Stationary Admin Page</h1>
    <div className="row">
      ...
      {/* table of users */}
      <h1 className="fs-3 text-center text-info mt-">List of items</h1>
...
export default Stationary_Admin